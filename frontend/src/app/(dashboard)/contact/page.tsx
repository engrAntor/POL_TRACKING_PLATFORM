    ...
    return (
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-14 w-full">
            ...
            <div className="bg-gray-50 rounded-2xl p-10 grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div className="space-y-8">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-5 py-4 bg-white border border-gray-200 rounded-xl text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0E3B1F] focus:border-transparent text-base"
                        />
                    </div>
                    <div>
                ...
                <div className="flex flex-col">
                    ...
                    <textarea
                        ...
                        className="flex-1 w-full px-5 py-4 bg-white border border-gray-200 rounded-xl text-gray-700 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0E3B1F] focus:border-transparent text-base resize-none min-h-[320px]"
                    />
                </div>
            </div>
            ...
            <div className="mt-8 flex justify-end">
                <button className="bg-[#0E3B1F] text-white px-10 py-4 rounded-xl font-semibold text-lg hover:bg-[#2d5a45] transition-colors">
                    Submit
                </button>
            </div>
        </div>
